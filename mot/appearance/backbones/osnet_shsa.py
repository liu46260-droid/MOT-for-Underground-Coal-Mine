...
class OSBlockSHSA(OSBlock):
    """Omni-scale feature learning block with SHSA."""
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(OSBlockSHSA, self).__init__(
            in_channels,
            out_channels,
            IN=IN,
        ...
        self.shsa = SHSA(out_channels, qk_dim=16, pdim=64)
    ...
    def forward(self, x):
        ...
        # Insert SHSA between 1x1 (conv3) and + (residual addition)
        x3 = self.shsa(x3)
...
# Instantiation
##########
def osnet_shsa_x1_0(num_classes=1000, pretrained=True, loss='softmax', **kwargs):
    # standard size (width x1.0)
    model = OSNet(
        num_classes,
        blocks=[OSBlock, OSBlock, OSBlockSHSA],
        layers=[2, 2, 2],
