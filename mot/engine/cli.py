...
# Add embedded ultralytics to sys.path to ensure we use the modified version
current_file = Path(__file__).resolve()
embedded_dir = current_file.parent.parent / 'embedded'
if embedded_dir.exists() and str(embedded_dir) not in sys.path:
    # print(f"Adding {embedded_dir} to sys.path")
